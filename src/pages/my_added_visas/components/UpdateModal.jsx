...
//     const [initialVisaType, setInitialVisaType] = useState(visaType);
//     const formRef = useRef()

//     const handleUpdateVisaType = (e) => {
//         setInitialVisaType(e.target.value)
//     }

//     const handleCloseModal = () => {
//         setInitialVisaType(visaType)
...
//                             name="visa_type"
//                             value={initialVisaType || visaType}
...
//                         <button type="submit" className="btn bg-gradient-to-r from-green-200 to-blue-300 dark:bg-gradient-to-r dark:from-purple-800 dark:to-gray-800">Update Visa</button>
...
const UpdateModal = ({ item = 0 }) => {
    ...
    const handleUpdateVisaType = (e) => {
        // Update the visaType state when the select value changes
        setInitialVisaType(e.target.value);
    };

    const handleCloseModal = () => {
        // Reset the initialVisaType state to the original visaType when closing the modal
        setInitialVisaType(visaType);
        formRef.current.reset();
        document.getElementById("update_visa_modal").close();
    };
                ...
                <form ref={formRef} className="card-body max-w-lg mx-auto" onSubmit={handleAddVisa}>
                    ...
                    <div className="form-control">
                        ...
                        <select
                            className="select w-full input input-bordered"
                            name="visa_type"
                            value={initialVisaType}  // Ensure it reflects the updated state
                            onChange={handleUpdateVisaType}  // Update the state on change
                            required
                        >
